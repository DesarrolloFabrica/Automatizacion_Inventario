...
run_flujo.py
  ...
  por lote:
     ...
     formato / verificacion / carga: "pendiente" (fases 2 y 3)
  cerrar_corrida, exportar_excel, resumen en consola
```
...
En la fase 2 la conversión JPG → PNG se hará **en el clon**, conservando el
...
Por eso toda comparación origen ↔ clon (clonación hoy; inventario y
verificación después) se hace por **nombre canónico**:
...
- Carga al esquema `fabrica` reutilizando el token único.
